...
const EditMaterial = () => {
  ...
  const fetchData = async () => {
    try {
      const [resClass, resMat] = await Promise.all([
      ...
      setFormData({
        title: resMat.data.title || '',
        description: resMat.data.description || '',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-border">
        <div className="flex items-center gap-4">
          <button 
            onClick={() => navigate(`/class/${id}/materials/${materialId}`)}
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-main">Edit Material</h1>
